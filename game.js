...
function Game() {
  ...
  this.state      = WAITING
  this.players    = []
  this.WHITE      = _.shuffle(CARDS.WHITE.slice())
  this.BLACK      = _.shuffle(CARDS.BLACK.slice())
...
Game.prototype.pickle = function () {
  ...
  , last      : this.last && {
    ...
    , blackcard : this.last.blackcard
    , whitecard : this.last.whitecard
